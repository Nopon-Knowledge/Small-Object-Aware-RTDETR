...
PR_PRESETS = {
    "gwhd_r50_baseline_vs_tsecaf": {
        ...
        "subtitle": "RT-DETRv2 R50 baseline vs TSECAF",
        "output_dir": str(PROJECT_ROOT / "vis_results" / "pr_curves" / "r50_baseline_vs_tsecaf"),
        "output_name": "r50_baseline_vs_tsecaf_pr50.svg",
        "series": [
            {
                "name": "R50 Baseline",
            ...
            {
                "name": "R50 + TSECAF",
                "eval_path": str(PROJECT_ROOT / "output" / "paper_eval" / "gwhd_r50_tsecaf" / "eval.pth"),
                "color": "#d62728",
            },
        ],
    },
...
if __name__ == "__main__":
    ...
    parser.add_argument("--preset", choices=sorted(PR_PRESETS), default="gwhd_r50_baseline_vs_tsecaf")

"""Continue GWHD2021 training from the last checkpoint for 30 more epochs.
"""
...
DEFAULT_CONFIG = "configs/rtdetrv2/rtdetrv2_s_a40_gwhd2021_resume30.yml"
DEFAULT_RESUME = str(PROJECT_ROOT / "output" / "rtdetrv2_s_100e_gwhd_a40_bs24" / "last.pth")


def configure_torch_runtime() -> None:
    # Match the other A40 launchers: some cluster CUDA setups expose GPUs but
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Resume RT-DETRv2-S GWHD2021 training from last.pth for 30 more epochs."
    )

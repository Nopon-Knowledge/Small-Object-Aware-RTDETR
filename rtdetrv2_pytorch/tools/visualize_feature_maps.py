...
VIS_PRESETS = {
    "gwhd_r50_baseline_vs_tsecaf": {
        "description": "Compare RT-DETRv2 R50 baseline and TSECAF feature responses on GWHD2021 validation images.",
        ...
        "ours_config": "configs/rtdetrv2/rtdetrv2_r50vd_180e_gwhd_wheat_tsecaf.yml",
        "ours_resume": str(PROJECT_ROOT / "output" / "rtdetrv2_r50vd_180e_gwhd_wheat_tsecaf" / "best.pth"),
        "input": str(DATASETS_ROOT / "gwhd_2021" / "val2017"),
        "ann_file": str(DATASETS_ROOT / "gwhd_2021" / "annotations" / "instances_val2017.json"),
        "output_dir": str(PROJECT_ROOT / "vis_results" / "feature_maps" / "r50_baseline_vs_tsecaf"),
        "device": "cuda:0",
        "max_images": 6,
        "selection": "densest",
        "input_size": None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--preset", choices=sorted(VIS_PRESETS), default="gwhd_r50_baseline_vs_tsecaf")

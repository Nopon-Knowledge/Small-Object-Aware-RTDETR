...
VIS_PRESETS = {
    "wheat_tsecaf_r18_val_best": {
        "description": "Visualize GWHD2021 validation predictions from the Wheat-TS-ECAF R18 best checkpoint.",
    ...
    "wheat_tsecaf_r50_val_best": {
        "description": "Visualize GWHD2021 validation predictions from the Wheat-TS-ECAF R50 best checkpoint.",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--preset", choices=sorted(VIS_PRESETS), default="wheat_tsecaf_r18_val_best")
